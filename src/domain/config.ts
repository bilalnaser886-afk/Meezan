...
export interface Env {
   ...
   *
   * حطّها = "1" في كلاودفلير فالتفاصيل بتنزل في الرد نفسه،
   * وتقراها من الموبايل مباشرةً.
   *
   * ⚠⚠ حطّها في بيئة **Preview** بس، واقفلها بعد ما تلاقي
   * السبب. لو سابتها مفتوحة في الإنتاج، أي زائر يقدر يشوف
   * أسماء جداولك ونصوص استعلاماتك.
   */
  DEBUG_ERRORS?: string;
}
