 ...
 *
 * ══ ⚠ ملاحظة على `encoder` تحت ══
 * المحوّل ده كان **معرّف مرتين** في الملف: مرة هنا فوق ومرة في
 * قسم البطاقة تحت. و`const` بنفس الاسم مرتين في نفس المستوى =
 * خطأ وقت **البناء**، يعني الملف ما كانش بيتترجم أصلاً.
 *
 * التعريف الأول بيغطّي الملف كله، فالتاني اتشال وخلاص — مفيش
 * أي تغيير في السلوك.
 */
...
/** ⚠ واحد للملف كله — بيستخدمه التجزئة والبصمة والبطاقة */
...
//
//  ⚠ القسم ده كان بيعرّف `encoder` تاني. اتشال — التعريف اللي
//  فوق الملف بيغطّيه، وبنفس القيمة بالظبط.
// ═══════════════════════════════════════════════════════════
