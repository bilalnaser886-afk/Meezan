...
export interface RepairShopMovement {
  ...
  createdByName: string | null;
  /**
   * الشغل ده كان على جهاز رجع تاني؟
   *
   * ⚠ محسوبة مش مخزّنة — بتتحسب من مصدرها وقت القراءة.
   *   جهاز عميل  →  التذكرة ليها زيارة سابقة
   *   جهاز محل   →  الجهاز راح الورشة قبل كده
   *
   * ⚠ والتكلفة الجديدة **سطر مستقل** من الأول، مش زيادة على
   * السطر القديم: كل رجوع بيتفتحله سجل جديد بمعرّف جديد،
   * والدين مربوط بالمعرّف.
   */
  isRevisit: boolean;
  /** الزيارة رقم كام — 1 يعني أول مرة */
  visitNumber: number;
}
